...
<head>
  ...
  <title>AI-Rohim Data Center</title>
...
<div class="wrapper">
  ...
  <!-- sidebar-dark-primary -->
    ...
    <a href="index3.html" class="brand-link bg-pink ">
      ...
      <span class="brand-text font-weight-light">AI-Rohim Data</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar sidebar-light-teal">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Imaduddin</a>
        </div>
      </div>
      ...
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-collapse-hide-child text-sm " data-widget="treeview" role="menu" data-accordion="false">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://">ARDC</a>.</strong>
    All rights reserved.
